...
All files in this scaffold are project-owned. Edit them directly as the project
evolves. The optional `tama/.tama-kit.json` receipt is generation history only.
Native Compose and Terraform commands below work without Tama Kit or a receipt.
